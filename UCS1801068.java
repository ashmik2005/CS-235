...
“ // Now here we have created a combiner function to combine the factorials and the after that we have initialised a function called Chess board to create the initial state // “
...
“ // Now we will be creating a find function and in this function we will find the row to insert the quest using a flags. We will be running a loop and in it if the arr.charAt(SIZE*I+J ) == 1 the we will set the flag to 1 if not the flag is zero // “
...
“// Now we will be creating a heuristic for the current state function. In this function we will be running a loop and we will be calculating sum of rows and columns as done in theory for heuristic approach. Then after that we will combine the sums using Comb function and after that we will be calculating sum of left and right and then also combining the results using comb function //“
...
“ // In this block of code i.e. display function we will be printing valid states . In this block we will be running a loop and printing all the valid states // “
...
“ // In this block of code i.e. display function we will be printing valid states . In this block we will be running a loop and printing all the valid states // “
  ...
  “ // This is the driver function // “
   ...
   Assignment_2 obj = new Assignment_2(); “// Created an object of the class // “
   ...
   ucs.add(sol); “ // Setting a priority queue // “
...
“ // Here in this class boardcomp implements comparator for inheritance //“
...

{
   ...
   public ChessBoard(String board, int cost, long heuristic) “ // a constructor is called //“
